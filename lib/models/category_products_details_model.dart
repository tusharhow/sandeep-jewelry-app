...
//
//     final categoryProductsDetailsModel = categoryProductsDetailsModelFromJson(jsonString);

import 'dart:convert';

CategoryProductsDetailsModel categoryProductsDetailsModelFromJson(String str) => CategoryProductsDetailsModel.fromJson(json.decode(str));

String categoryProductsDetailsModelToJson(CategoryProductsDetailsModel data) => json.encode(data.toJson());

class CategoryProductsDetailsModel {
    CategoryProductsDetailsModel({
     required   this.data,
    ...
    factory CategoryProductsDetailsModel.fromJson(Map<String, dynamic> json) => CategoryProductsDetailsModel(
...
class Assets {
    ...
    factory Assets.fromJson(Map<String, dynamic> json) => Assets(
        ...
        diamond: List<Diamond>.from(json["Diamond"].map((x) => Diamond.fromJson(x))),
...
class Diamond {
    ...
    factory Diamond.fromJson(Map<String, dynamic> json) => Diamond(
        ...
        color: json["color"],
        // diamondtype: json["diamondtype"] == null ? null : List<Diamondtype>.from(json["diamondtype"].map((x) => Diamondtype.fromJson(x))),
    ...
    Map<String, dynamic> toJson() => {
        ...
        "dia_rate": diaRate,
        "color": color,
        // "diamondtype": diamondtype == null ? null : List<dynamic>.from(diamondtype.map((x) => x.toJson())),
...
class Diamondtype {
   ...
   required     this.id,
    ...
    factory Diamondtype.fromJson(Map<String, dynamic> json) => Diamondtype(
        id: json["id"],
        metrial: json["metrial"],
...
class Gold {
    ...
    factory Gold.fromJson(Map<String, dynamic> json) => Gold(
        ...
        materialPricePerUnit: json["material_price_per_unit"],
        weight: json["weight"],
        wastage: json["wastage"],
        quantity: json["quantity"],
    ...
    Map<String, dynamic> toJson() => {
        ...
        "material_price_per_unit": materialPricePerUnit,
        "weight": weight,
        "wastage": wastage,
        "quantity": quantity,
...
class Data {
    ...
    factory Data.fromJson(Map<String, dynamic> json) => Data(
        ...
        certifiedId: List<CertifiedId>.from(json["certified_id"].map((x) => CertifiedId.fromJson(x))),
        jewelleryColor: List<JewelleryColor>.from(json["jewellery_color"].map((x) => JewelleryColor.fromJson(x))),
        defaultSize: json["default_size"],
        jewellerySize: List<JewellerySize>.from(json["jewellery_size"].map((x) => JewellerySize.fromJson(x))),
        amount: json["amount"],
    ...
    Map<String, dynamic> toJson() => {
        ...
        "jewellery_color": List<dynamic>.from(jewelleryColor.map((x) => x.toJson())),
        "default_size": defaultSize,
        "jewellery_size": List<dynamic>.from(jewellerySize.map((x) => x.toJson())),
        "amount": amount,
