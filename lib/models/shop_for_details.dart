...
//
//     final shopForCategoryDetailsModel = shopForCategoryDetailsModelFromJson(jsonString);

import 'dart:convert';

ShopForCategoryDetailsModel shopForCategoryDetailsModelFromJson(String str) =>
    ShopForCategoryDetailsModel.fromJson(json.decode(str));

String shopForCategoryDetailsModelToJson(ShopForCategoryDetailsModel data) =>
    json.encode(data.toJson());

class ShopForCategoryDetailsModel {
  ShopForCategoryDetailsModel({
    required this.data,
  ...
  factory ShopForCategoryDetailsModel.fromJson(Map<String, dynamic> json) =>
      ShopForCategoryDetailsModel(
